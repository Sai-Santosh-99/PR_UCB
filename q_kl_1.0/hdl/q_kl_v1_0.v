...
`timescale 1 ns / 1 ps
	...
	(
		...
		output wire [31:0] final_kl,
		output wire final_kl_valid,
		
		output wire final_ucb_valid,
        output wire [31:0] final_ucb,
...
// Instantiation of Axi Bus Interface S_X
    ...
    .C_S_AXIS_N_TDATA_WIDTH(C_S_N_TDATA_WIDTH)	 
        ...
        .final_kl(final_kl),
        .final_kl_valid(final_kl_valid),
        
        .final_ucb(final_ucb),
        .final_ucb_valid(final_ucb_valid)
	);
